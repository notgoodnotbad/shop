...
<div class="form-div">
    ...
    <table cellpadding="3" cellspacing="1">
        ...
        <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                <td class="first-cell"><?php echo ($row["name"]); ?></td><td class="first-cell"><?php echo ($row["short_name"]); ?></td><td class="first-cell"><?php echo ($row["sn"]); ?></td><td class="first-cell"><?php echo ($row["goods_category_id"]); ?></td><td class="first-cell"><?php echo ($row["brand_id"]); ?></td><td class="first-cell"><?php echo ($row["supplier_id"]); ?></td><td class="first-cell"><?php echo ($row["shop_price"]); ?></td><td class="first-cell"><?php echo ($row["market_price"]); ?></td><td class="first-cell"><?php echo ($row["logo"]); ?></td><td class="first-cell"><?php echo ($row["stock"]); ?></td><td class="first-cell"><?php echo ($row["goods_status"]); ?></td><td align="center"><a class="ajax-get" href="<?php echo U('changStatus',array('id'=>$row['id'],'status'=>(1-$row['status'])));?>"><img src="http://admin.shop.com/Public/Admin/images/<?php echo ($row["status"]); ?>.gif"/></a></td>
                <td align="center">
